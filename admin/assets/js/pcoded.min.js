(function ($) {
  jQuery.fn.pcodedmenu = function (settings) {
  ...
  // menu [ horizontal ]
  jQuery(window).scroll(function ($) {
    if (jQuery(this).scrollTop() > 56) {
      jQuery('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css('position', 'fixed');
      jQuery('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css('top', 0);
    } else {
      jQuery('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css('position', 'absolute');
      jQuery('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css('top', 'auto');
    }
  });
  // menu [ compact ]
  jQuery(window).on('load', function ($) {
    jQuery('.pcoded[vertical-nav-type="collapsed"] .pcoded-navbar').hover(function () {
      jQuery('.pcoded').attr("vertical-nav-type", "expanded");
    }, function () {
      jQuery('.pcoded').attr("vertical-nav-type", "collapsed");
    });
    // jQuery('pcoded-inner-navbar li.active').children('.pcoded-submenu').slideDown();
  });
